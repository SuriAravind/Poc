...
///Users/apple/Downloads/CobolXml.xml
        args = new String[]{"-cobol", "/Users/apple/Documents/Projects/VSAM/cobrix-master/data/test3_copybook.cob", "-indentXml", "-xml"};
        ...
        if (p.ok) {
            try {
                ...
                if (p.xml == null || p.xml.length() == 0) {
                    ...
                    // bldr.setXmlEncoding("").writeXml(new OutputStreamWriter(System.out));
                   // bldr.setXmlEncoding("").writeXml(new OutputStreamWriter(new FileOutputStream(p.xml)));
                    //bldr.writeXml(p.xml);
                }
