...
java -jar ../lib/Cobol2Xml.jar -cobol DTAR020.cbl -font cp037 -fileOrganisation FixedWidth -dropCopybookName true ^
                             -input in/DTAR020.bin   ^
...
java -jar ../lib/Cobol2Xml.jar -cobol FCUSDAT.cbl -font cp037 -fileOrganisation Mainframe_VB  ^
                             ...
                             -output out/ZOS.FCUSTDAT_150.xml 

rem mainframe VB, Occurs depending
java -jar ../lib/Cobol2Xml.jar -cobol FCUSDAT.cbl -font cp037 -fileOrganisation Mainframe_VB  ^
                             -input  in/ZOS.FCUSTDAT_150.vb.bin   ^
                             -output out/ZOS.FCUSTDAT_150_Bat.xml 

rem   Multi Record File 
...
rem   Multi Record File, Define the Record-Hierarchy to get a proper Tree layout of the Xml
java -jar ../lib/Cobol2Xml.jar -cobol amsPoDownload.cbl -fileOrganisation text  ^
                                 -split 01 ^
                                 -recordSelection PO-Record        Record-Type=H1 ^
...
rem    use the  -tagFormat to format the Xml-Tags using Camel-Case or Underscore (instead of Cobols -)
java -jar ../lib/Cobol2Xml.jar -cobol DTAR020.cbl -font cp037 -fileOrganisation FixedWidth ^
                             -input in/DTAR020.bin ^
