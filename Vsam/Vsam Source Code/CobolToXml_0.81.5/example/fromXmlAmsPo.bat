...
java -jar ../lib/Xml2Cobol.jar -cobol G:/Users/Bruce01/RecordEditor_HSQL/Copybook/Cobol/amsPoDownload.cbl ^
                               ...
                               -input  out/Ams_PODownload_20041231.txt.xml ^
                               -output out/Ams_PODownload_20041231_out.txt
pause                               
