...
import com.p3solutions.writer.utility.html.*;
...
abstract class BaseTextFormattingHelper implements TextFormattingHelper {
     ...
     * {@inheritDoc}
     *
     * @see TextFormattingHelper#writeDescriptionRow(String)
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see TextFormattingHelper#writeDetailRow(String,
     * String, boolean, String, boolean)
     */
    @Override
    public void writeDetailRow(final String ordinal, final String subName, final boolean escapeText,
                               final String type, final boolean emphasize) {
     ...
     * {@inheritDoc}
     *
     * @see TextFormattingHelper#writeDetailRow(String, String,
     * String)
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see TextFormattingHelper#writeNameRow(String,
     * String)
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see TextFormattingHelper#writeNameValueRow(String,
     * String, Alignment)
     */
    @Override
    ...
    public void writeRow(final Object... columnData) {
        ...
        for (final Object element : columnData) {
            ...
            } else if (element.toString().startsWith(".." + File.separator + "BLOBs")) {
                row.add(new TableCell(createAnchor(element.toString(), element.toString().replaceFirst(".." + File.separator, "")), false, 100, Alignment.inherit, false, "", Color.white, 1, outputFormat));
            } else {
    ...
    public void writeRowHeader(final String... columnNames) {
        ...
        for (final String columnName : columnNames) {
            final TableHeaderCell headerCell =
                    new TableHeaderCell(columnName, 0, Alignment.inherit, true, "", Color.white, 1, outputFormat);
            row.add(headerCell);
        }
    ...
    private TableCell newTableCell(final String text, final String styleClass, final TextOutputFormat outputFormat) {
