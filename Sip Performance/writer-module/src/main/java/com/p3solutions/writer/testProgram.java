/*
package com.p3solutions.writer;
...
public class testProgram {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String outputDir = "/Users/malik/Documents/testWriterModule/" + outputType + "/" + new Date().getTime();
    ...
    private void SipHelperMysql(String outputDir, String outputType, String title) {
        Options options =
                new Options().builder().FileSplitByRecords(100).fileSplitBySize(2 * 1024 * 1024).thresholdSize(1 * 1024)
                        .inputEncodingCharset(StandardCharsets.UTF_8)
                        .outputEncodingCharset(StandardCharsets.UTF_8)
