...
public final class OutputWriter extends Writer {
    ...
    public OutputWriter(final String description, final Writer writer, final boolean shouldCloseWriter) {
    ...
    protected void finalize() throws Throwable {
        if (!isClosed) {
            throw new IllegalStateException(String.format("Output writer \"%s\" was not closed", description));
        }
        super.finalize();
    }
